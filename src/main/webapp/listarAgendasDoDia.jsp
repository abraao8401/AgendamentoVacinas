...
<head>
    ...
    <title>Agendas do Dia</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Agendas do Dia</h1>

        <!-- Botões de ações -->
        <div class="mb-3">
            <a href="agenda?action=listar" class="btn btn-primary">Todas as Agendas</a>
            <a href="agenda?action=listarPorSituacao&situacao=CANCELADA" class="btn btn-warning">Agendas Canceladas</a>
            <a href="agenda?action=listarPorSituacao&situacao=REALIZADA" class="btn btn-success">Agendas Realizadas</a>
            <a href="agenda?action=listarDoDia" class="btn btn-info">Agendas do Dia</a>
        </div>

        <!-- Tabela de agendas do dia -->
